    ...
    return (
      <div className="pb-6" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'SF Pro Display', 'Inter', sans-serif", background: BG, minHeight: "100vh", margin: "-12px -12px 0" }}>
        ...
        <div className="px-5 pt-3 flex items-center gap-[8px]">
          ...
          <span className="text-[12px] font-semibold" style={{ color: T2 }}>Exam Results</span>
        </div>
        ...
        <div className="mx-5 mt-3 rounded-[22px] bg-white p-[16px] relative overflow-hidden"
          ...
          <div className="flex items-start justify-between gap-3 mb-3 relative">
            <div className="min-w-0 flex-1">
              <div className="text-[20px] font-semibold leading-tight tracking-[-0.4px] capitalize mb-1 truncate" style={{ color: T1 }}>
                {exam.name}
              </div>
            ...
            <div className="flex gap-3 flex-shrink-0">
              <div className="text-right">
                <div className="text-[22px] font-semibold leading-none tracking-[-0.6px]" style={{ color: passColor }}>
                  {exam.passRate}%
                </div>
                <div className="text-[12px] font-semibold uppercase tracking-[0.09em] mt-[4px]" style={{ color: T4 }}>Pass Rate</div>
              </div>
              <div className="text-right">
                <div className="text-[22px] font-semibold leading-none tracking-[-0.6px]" style={{ color: avgColor }}>
                  {exam.avgPct}%
                </div>
                <div className="text-[12px] font-semibold uppercase tracking-[0.09em] mt-[4px]" style={{ color: T4 }}>Average</div>
              </div>
            </div>
          </div>
        ...
        {exam.classSummary.length > 0 && (
          <div className="mx-5 mt-3 rounded-[22px] bg-white overflow-hidden"
            ...
            <div className="px-[16px] pt-[16px] pb-3" style={{ borderBottom: `0.5px solid ${SEP}` }}>
              <div className="text-[14px] font-semibold" style={{ color: T1 }}>Class-wise Results Summary</div>
            </div>
            <div className="grid gap-1 px-4 py-[8px]" style={{ gridTemplateColumns: "1fr .7fr .7fr .7fr 1fr .7fr", background: BG, borderBottom: `0.5px solid ${SEP}` }}>
              <span className="text-[12px] font-semibold uppercase tracking-[0.09em]" style={{ color: T4 }}>Section</span>
              <span className="text-[12px] font-semibold uppercase tracking-[0.09em]" style={{ color: T4 }}>App.</span>
              <span className="text-[12px] font-semibold uppercase tracking-[0.09em]" style={{ color: GREEN }}>Pass</span>
              <span className="text-[12px] font-semibold uppercase tracking-[0.09em]" style={{ color: RED }}>Fail</span>
              <span className="text-[12px] font-semibold uppercase tracking-[0.09em]" style={{ color: T4 }}>Topper</span>
              <span className="text-[12px] font-semibold uppercase tracking-[0.09em]" style={{ color: T4 }}>Avg%</span>
            </div>
            {exam.classSummary.map((row, i, arr) => (
              <div key={row.section} className="grid gap-1 px-4 py-[12px] items-center"
                ...
                <span className="text-[12px] font-semibold" style={{ color: T1 }}>{row.section}</span>
                <span className="text-[12px] font-semibold" style={{ color: T1 }}>{row.appeared}</span>
                <span className="text-[12px] font-semibold" style={{ color: GREEN }}>{row.passed}</span>
                <span className="text-[12px] font-semibold" style={{ color: RED }}>{row.failed}</span>
                <span className="text-[12px] font-semibold truncate" style={{ color: T1 }}>{row.topper}</span>
                <span className="text-[12px] font-semibold" style={{ color: avgScoreColor(row.avgPct) }}>{row.avgPct}%</span>
              </div>
            ))}
          </div>
        )}
        ...
        {exam.meritList.length > 0 && (
          <div className="mx-5 mt-3 rounded-[22px] bg-white overflow-hidden"
            ...
            <div className="px-[16px] pt-[16px] pb-3 flex items-center justify-between" style={{ borderBottom: `0.5px solid ${SEP}` }}>
              <div className="text-[14px] font-semibold" style={{ color: T1 }}>🏆 School Merit List (Top {exam.meritList.length})</div>
            </div>
            {exam.meritList.map((m, i, arr) => {
              ...
              return (
                <div key={`${m.name}-${i}`} className="flex items-center gap-[12px] px-[16px] py-[16px] transition-colors active:bg-[rgba(10,132,255,0.04)]"
                  ...
                  <div className="w-7 h-7 rounded-[9px] flex items-center justify-center text-[13px] font-semibold flex-shrink-0"
                    style={{ background: rankGrad, color: rankColor, boxShadow: rankShadow }}>
                    {m.rank}
                  </div>
                  <div className="w-10 h-10 rounded-[13px] flex items-center justify-center text-[14px] font-semibold text-white flex-shrink-0"
                    style={{ background: avGrad(m.name), boxShadow: "0 2px 8px rgba(10,132,255,0.24)" }}>
                    {initialsOf(m.name)}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[14px] font-semibold tracking-[-0.2px] truncate" style={{ color: T1 }}>{m.name}</div>
                    <div className="text-[12px] font-semibold mt-[2px] truncate" style={{ color: T4 }}>Class {m.className}</div>
                  </div>
                  <div className="text-right flex-shrink-0">
                    <div className="text-[18px] font-semibold leading-none tracking-[-0.3px]" style={{ color: scoreColor }}>{m.avgPct}%</div>
                    <div className="inline-flex items-center justify-center mt-[4px] px-[8px] py-[2px] rounded-full text-[12px] font-semibold"
        ...
        <div className="mx-5 mt-3 rounded-[22px] bg-white overflow-hidden"
          style={{ boxShadow: SHADOW_LG, border: "0.5px solid rgba(10,132,255,0.10)" }}>
          <div className="px-[16px] pt-[16px] pb-3 flex items-center justify-between" style={{ borderBottom: `0.5px solid ${SEP}` }}>
            <div className="text-[14px] font-semibold" style={{ color: T1 }}>⚠ Fail List (Needs Attention)</div>
          </div>
          {exam.failList.length === 0 ? (
            <div className="py-6 px-[16px] flex flex-col items-center gap-[8px]">
              ...
              <div className="text-[14px] font-semibold tracking-[-0.2px]" style={{ color: GREEN }}>No failed students — great!</div>
            ...
            exam.failList.map((f, i, arr) => (
              <div key={`${f.name}-${i}`} className="flex items-center gap-[12px] px-[16px] py-[12px]"
                style={{ borderBottom: i < arr.length - 1 ? `0.5px solid ${SEP}` : undefined }}>
                <div className="w-9 h-9 rounded-[12px] flex items-center justify-center text-[12px] font-semibold text-white flex-shrink-0"
                  style={{ background: "linear-gradient(135deg, #FF3B30, #FF5E55)", boxShadow: "0 2px 8px rgba(255,59,48,0.24)" }}>
                  {f.initials}
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-[13px] font-semibold tracking-[-0.2px] truncate" style={{ color: T1 }}>{f.name}</div>
                  <div className="text-[12px] font-semibold mt-[1px] truncate" style={{ color: T4 }}>Class {f.className}</div>
                </div>
                <div className="text-[15px] font-semibold tracking-[-0.3px] flex-shrink-0" style={{ color: RED }}>{f.avgPct}%</div>
              </div>
            ))
          )}
        </div>
        ...
        <div className="mx-5 mt-3 rounded-[22px] px-5 py-[16px] relative overflow-hidden"
          ...
          <div className="text-[12px] leading-[1.72] relative z-10" style={{ color: "rgba(255,255,255,0.85)" }}>
            {aiVerdict} with a <strong style={{ color: "#fff", fontWeight: 600 }}>{exam.passRate}% pass rate</strong> and an average of <strong style={{ color: "#fff", fontWeight: 600 }}>{exam.avgPct}%</strong>.
            {topMerit && <> <strong style={{ color: "#fff", fontWeight: 600 }}>{topMerit.name}</strong> leads with <strong style={{ color: "#fff", fontWeight: 600 }}>{topMerit.avgPct}%</strong>.</>}
            {exam.failList.length > 0
        ...
        <div className="flex gap-2 px-5 pt-3.5 flex-wrap">
          <button onClick={handleDownload}
            className="flex-1 min-w-[100px] h-[42px] rounded-[14px] flex items-center justify-center gap-[8px] text-[12px] font-semibold text-white transition-transform active:scale-95 relative overflow-hidden"
          ...
          <button onClick={handlePrint}
            className="flex-1 min-w-[100px] h-[42px] rounded-[14px] flex items-center justify-center gap-[8px] text-[12px] font-semibold bg-white transition-transform active:scale-95"
        ...
        <div className="flex gap-2 px-5 pt-2 flex-wrap">
          <button onClick={handleShare}
            className="flex-1 min-w-[100px] h-[42px] rounded-[14px] flex items-center justify-center gap-[8px] text-[12px] font-semibold transition-transform active:scale-95"
        ...
        <button onClick={onBackFromDetail}
          className="mx-5 mt-3 h-10 px-[16px] rounded-[13px] flex items-center gap-[8px] text-[12px] font-semibold bg-white transition-colors active:bg-[#F5F5F7]"
    ...
    <div className="pb-6" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'SF Pro Display', 'Inter', sans-serif", background: BG, minHeight: "100vh", margin: "-12px -12px 0" }}>
      ...
      <div className="px-5 pt-3 flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="text-[12px] font-semibold uppercase tracking-[0.10em] mb-[4px] flex items-center gap-[4px]" style={{ color: T4 }}>
        ...
        <button onClick={handleCreateExam}
          className="h-[38px] px-[16px] rounded-[13px] flex items-center gap-[8px] text-[12px] font-semibold text-white whitespace-nowrap flex-shrink-0 transition-transform active:scale-95 relative overflow-hidden mt-1"
          style={{ background: GRAD_PRIMARY, boxShadow: SHADOW_BTN }}>
          <span className="absolute inset-0 pointer-events-none" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.14) 0%, transparent 52%)" }} />
          ...
          <div className="flex items-center justify-between mb-[16px] relative z-10">
            <div className="flex items-center gap-[12px] min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[24px] font-semibold text-white leading-none tracking-[-0.7px] truncate capitalize">
                  {latestExam.name}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-[4px] px-3 py-[4px] rounded-full flex-shrink-0"
              ...
              <span className="text-[12px] font-semibold" style={{ color: "#34C759" }}>{latestExam.dateLabel}</span>
            </div>
          </div>
      ...
      <div className="mx-5 mt-3 rounded-[22px] bg-white overflow-hidden"
        ...
        <div className="px-[16px] pt-4 pb-3 flex items-center justify-between" style={{ borderBottom: `0.5px solid ${SEP}` }}>
          <div className="text-[15px] font-semibold" style={{ color: T1 }}>Upcoming Exams</div>
          <button onClick={handleCreateExam}
            className="h-8 px-3 rounded-[10px] text-[12px] font-semibold text-white flex items-center gap-[4px] active:scale-95 transition-transform"
        ...
        {upcomingExams.length === 0 ? (
          <div className="py-[24px] px-5 flex flex-col items-center gap-[8px]">
            ...
            <div className="text-[14px] font-semibold tracking-[-0.2px]" style={{ color: T2 }}>No upcoming exams scheduled</div>
          ...
          upcomingExams.slice(0, 6).map((ex: any, i: number, arr: any[]) => (
            <div key={ex.id || i} className="px-[16px] py-[16px] flex items-center gap-3"
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[13px] font-semibold truncate" style={{ color: T1 }}>{ex.testName || ex.subject || "Upcoming"}</div>
                <div className="text-[12px] font-semibold mt-[2px]" style={{ color: T4 }}>
      ...
      <div className="grid grid-cols-2 gap-[12px] px-5 pt-3">
        ...
        <button onClick={() => latestExam && onSelectExam(latestExam)} disabled={!latestExam}
          ...
          <div className="text-[12px] font-semibold uppercase tracking-[0.07em] mb-[8px]" style={{ color: T4 }}>Latest Exam</div>
          <div className="text-[16px] font-semibold tracking-[-0.2px] mb-1 capitalize truncate" style={{ color: T1 }}>
            {latestExam ? latestExam.name : "—"}
          </div>
          <div className="text-[12px] font-semibold flex items-center gap-[4px]" style={{ color: B1 }}>
        ...
        <div className="rounded-[20px] p-[16px] bg-white relative overflow-hidden"
          ...
          <div className="text-[12px] font-semibold uppercase tracking-[0.07em] mb-[8px]" style={{ color: T4 }}>Students Appeared</div>
          <div className="text-[28px] font-semibold leading-none tracking-[-0.8px] mb-1" style={{ color: B1 }}>
            {latestExam ? latestExam.totalStudents : 0}
          </div>
          <div className="text-[12px] font-semibold" style={{ color: T4 }}>
        ...
        <div className="rounded-[20px] p-[16px] bg-white relative overflow-hidden"
          ...
          <div className="text-[12px] font-semibold uppercase tracking-[0.07em] mb-[8px]" style={{ color: T4 }}>Pass Rate</div>
          <div className="text-[28px] font-semibold leading-none tracking-[-0.8px] mb-1"
        ...
        <div className="rounded-[20px] p-[16px] bg-white relative overflow-hidden"
          ...
          <div className="text-[12px] font-semibold uppercase tracking-[0.07em] mb-[8px]" style={{ color: T4 }}>School Topper</div>
          <div className="text-[14px] font-semibold tracking-[-0.2px] mb-1 truncate" style={{ color: T1 }}>
            {topper ? topper.name : "—"}
          </div>
      ...
      <div className="grid grid-cols-2 gap-[12px] px-5 pt-3">
        ...
        <div className="rounded-[20px] p-4 bg-white"
          style={{ boxShadow: SHADOW_LG, border: "0.5px solid rgba(10,132,255,0.10)" }}>
          <div className="text-[13px] font-semibold tracking-[-0.2px] mb-[16px]" style={{ color: T1 }}>Pass Rates</div>
          <div className="flex items-end gap-[8px] h-20 mb-2">
              ...
              return (
                <div key={s.name || i} className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full rounded-t-[5px] relative" style={{ height: `${heightPct}%`, background: `linear-gradient(180deg, ${color}, ${color}AA)`, boxShadow: `0 3px 10px ${color}42`, minHeight: 4 }}>
                    <div className="absolute -top-[16px] left-1/2 -translate-x-1/2 text-[12px] font-semibold whitespace-nowrap" style={{ color: T1 }}>{s.passRate}%</div>
                  </div>
                  <div className="text-[12px] font-semibold uppercase tracking-[0.04em] truncate max-w-full" style={{ color: T4 }}>
                    {s.name.slice(0, 4)}
                  </div>
                </div>
              );
            ...
            {subjectData.length === 0 && (
              <div className="flex-1 flex items-center justify-center text-[12px] font-semibold" style={{ color: T4 }}>
                No subject data
              </div>
            )}
          </div>
          <div className="flex gap-[8px] mt-1">
            <div className="flex items-center gap-1 text-[12px] font-semibold" style={{ color: T4 }}>
        ...
        <div className="rounded-[20px] p-4 bg-white"
          style={{ boxShadow: SHADOW_LG, border: "0.5px solid rgba(10,132,255,0.10)" }}>
          <div className="text-[13px] font-semibold tracking-[-0.2px] mb-[16px]" style={{ color: T1 }}>Grade Distribution</div>
          <div className="flex flex-col items-center gap-[12px]">
            <div className="relative w-[90px] h-[90px]">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                <div className="text-[16px] font-semibold leading-none tracking-[-0.4px]" style={{ color: T1 }}>
                  {donutTotal > 0 ? `${topBarPct}%` : "—"}
                </div>
                <div className="text-[12px] font-semibold uppercase tracking-[0.07em] mt-[2px]" style={{ color: T4 }}>
                  {topBarLabel}
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-[8px] w-full">
              {donutSegments.length > 0 ? donutSegments.map((seg, i) => (
                <div key={i} className="flex items-center gap-[8px] text-[12px] font-semibold" style={{ color: T3 }}>
                  <div className="w-2 h-2 rounded-[2px] flex-shrink-0" style={{ background: seg.color }} />
                  <span className="truncate">{seg.name} · {seg.pct}%</span>
                </div>
              )) : (
                <div className="text-[12px] font-semibold text-center" style={{ color: T4 }}>No data</div>
              )}
            </div>
          </div>
        </div>
      ...
      {examGroups.length === 0 ? (
        <div className="mx-5 mt-3 rounded-[22px] p-8 bg-white text-center"
          ...
          <p className="text-[12px] font-semibold uppercase tracking-[0.12em]" style={{ color: T3 }}>No exam results yet</p>
        ...
        <div className="mx-5 mt-3 rounded-[22px] bg-white overflow-hidden"
          ...
          {examGroups.map((exam, i, arr) => (
            <div key={exam.name} className="flex items-center gap-[12px] px-[16px] py-[16px] transition-colors active:bg-[#F5F5F7]"
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[14px] font-semibold tracking-[-0.2px] capitalize truncate" style={{ color: T1 }}>{exam.name}</div>
                <div className="text-[12px] font-semibold mt-[2px]" style={{ color: T4 }}>
              ...
              <div className="flex flex-col items-end gap-[4px] flex-shrink-0">
                ...
                <button onClick={() => onSelectExam(exam)}
                  className="h-9 px-[12px] rounded-[12px] text-[12px] font-semibold text-white flex items-center gap-[4px] active:scale-95 transition-transform relative overflow-hidden"
      ...
      {latestExam && (
        <div className="mx-5 mt-3 rounded-[22px] px-5 py-[16px] relative overflow-hidden"
          ...
          <div className="text-[12px] leading-[1.72] relative z-10" style={{ color: "rgba(255,255,255,0.85)" }}>
            The <strong style={{ color: "#fff", fontWeight: 600 }}>{latestExam.name}</strong> exam shows a <strong style={{ color: "#fff", fontWeight: 600 }}>{latestExam.passRate}% pass rate</strong> with an average of <strong style={{ color: "#fff", fontWeight: 600 }}>{latestExam.avgPct}%</strong>.
            {topper && <> <strong style={{ color: "#fff", fontWeight: 600 }}>{topper.name}</strong> topped at <strong style={{ color: "#fff", fontWeight: 600 }}>{topper.avgPct}%</strong>.</>}
            {upcomingExams.length === 0
      ...
      {!latestExam && examGroups.length === 0 && (
        <div className="mx-5 mt-3 rounded-[22px] p-8 bg-white text-center"
          ...
          <p className="text-[13px] font-semibold tracking-[-0.2px]" style={{ color: T1 }}>No exam data yet</p>

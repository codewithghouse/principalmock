...
const AppSidebar = ({ onClose }: AppSidebarProps) => {
  ...
  return (
    <aside className="w-[calc(100%-10px)] h-[calc(100%-20px)] mt-[12px] mb-[12px] ml-[12px] bg-card flex flex-col shrink-0 overflow-y-auto rounded-2xl shadow-[0_8px_28px_rgba(15,23,42,0.18)] md:shadow-[0_8px_28px_rgba(15,23,42,0.08)]">

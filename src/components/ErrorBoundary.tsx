      ...
      return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 gap-6">
          ...
          <div className="text-center max-w-md">
            <h1 className="text-xl font-normal text-slate-900 mb-2">Something went wrong</h1>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#1D1D1F] text-white text-sm font-normal hover:bg-[#0A84FF] transition-colors"
            >
